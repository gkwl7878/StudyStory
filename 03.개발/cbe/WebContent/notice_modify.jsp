...
<body>
	...
	<div class="container form-group" id="wrap" >
	 ...
	 <a class="btn btn-secondary btn" href="#void" role="button" style="margin-left: 250px; margin-top: 30px;" >목록으로</a> 
	<a class="btn btn-secondary btn" href="#void" role="button" style="margin-left:10px ;margin-top: 30px; ">수정</a>
	<a class="btn btn-secondary btn" href="#void" role="button" style="margin-left:10px ;margin-top: 30px; ">삭제</a>
	</div>
</form>
