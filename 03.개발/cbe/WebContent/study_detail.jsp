...
<body>
	...
	<div id="wrap" >
		<form action="create_request.jsp" name="createFrm">
		 <br/>
		 <br/>
		<label id="title"><strong>상세 스터디 정보</strong></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img alt="" src="Resources/images/create.png" style="width: 150px; height: 120px;">
		<br/>
		<br/>
		 <br/>
  <div class="form-group">
 <br/>
 	<label for="exampleFormControlSelect1" id="sub_title" style="font-size: 30px;">스터디명</label>
