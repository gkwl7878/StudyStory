...
<body>
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="주제" style="width: 500px;" >
    </div>
  </div>		
 <div class="form-group row">
    <label for="exampleFormControlTextarea1" style="font-size: 20px;"><strong>지역</strong></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="지역" style="width: 500px;" >
    </div>
  </div>		
 <div class="form-group row">
    <label for="exampleFormControlTextarea1" style="font-size: 20px;"><strong>참여자 수</strong></label>&nbsp;&nbsp;&nbsp;
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="스터디명" style="width: 500px;" >
    </div>
  </div>		
 <div class="form-group row">
    <label for="exampleFormControlTextarea1" style="font-size: 20px;"><strong>생성일</strong></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="생서일" style="width: 500px;" >
    </div>
  </div>		
  <br/>
 <div class="form-group row">
