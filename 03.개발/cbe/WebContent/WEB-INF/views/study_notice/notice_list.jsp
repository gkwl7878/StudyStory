  ...
  <!-- 점보트론 : 전광판 -->
      	...
      	<!--공지사항이 있으면 표시  -->
		    <c:forEach items="${ snList }" var="studyNotice">
		   	<div class="card select-card border-dark m-3 p-2" style="width:300px; min-height:150px;" onclick="location.href='notice_detail.do?sn_num=${ studyNotice.snNum }&s_num=${ param.s_num }'">
		   		<div class="card-body">
