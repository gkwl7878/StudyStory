    ...
    <div class="row">
	  ...
	  <div class="row" style="margin-top:30px;">
	    ...
	    <div class="col-7" style="padding-right:0px;">
	    	<input id="addr" value="${ snDetail.addr }" name="addr" readonly="readonly" type="text" class="form-control form-control-sm" placeholder="주소명"/>
	    </div>
	  ...
	  <div class="row" style="margin-top:30px;">
	   	...
	   	<div class="col-9">
	   		<input id="meeting_info" value="${ snDetail.meetingInfo }" name="meeting_info" type="text" class="form-control" placeholder="모임 시간을 입력해주세요"/>
	   	</div>
	  </div>
	   <div class="row justify-content-center" style="min-height:100px; margin-top:30px;">
	   	...
	   	<button id="modifyBtn" type="button" class="btn btn-secondary" style="height:40px; width:120px;">수정</button>
	   </div>
		</div>
	</form>
