	...
	<div id="wrap">
		<div class="mx-auto" style="width: 920px; height: 1100px; border: 1px solid #D7D7D7; padding: 30px;">
			...
			<form id="join_frm" action="../study_info/join_process.do" method="POST">
				...
				<textarea class="form-control" id="introduce_ta" name="introduce_ta" rows="4" style="resize: none; height: 180px;"
					placeholder="자기소개는 100자 이하로 입력해주세요."></textarea>
		...
		<div>
			<input id="back_btn" type="button" class="btn btn-secondary btn-lg" role="button" style="margin-left: 40%; margin-top: 15px;" value="돌아가기" /> <input
				id="apply_btn" type="button" class="btn btn-secondary btn-lg" role="button" style="margin-left: 10px; margin-top: 15px" value="참여하기" />
		</div>
	</div>
