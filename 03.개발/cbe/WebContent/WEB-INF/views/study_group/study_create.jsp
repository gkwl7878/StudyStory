...
<form id="createFrm" action="create_study_process.do" method="post" enctype="multipart/form-data">	
    ...
    <!-- 점보트론 : 전광판 -->
			...
			<div class="form-group" style="margin-bottom: 70px; margin-top: 40px;" >
				...
				<img alt="" src="/third_prj/resources/images/sub.png"
			...
			<div class="form-group" style="margin-bottom: 70px;">
				<img alt="" src="/third_prj/resources/images/loc.png" style="width: 50px; height: 50px; margin-bottom: 20px; margin-right: 15px;"> <label class="font30">새로운 스터디 그룹의 주 <strong>지역</strong>은 어디인가요?
				</label>
			...
			<div class="form-group" style="margin-bottom: 70px;">
				<img alt="" src="/third_prj/resources/images/name.png" style="width: 50px; height: 50px; margin-bottom: 20px; margin-right: 15px;"> <label class="font30">스터디의 <strong>이름</strong>을 정해주세요
			...
			<div class="form-group" style="margin-bottom: 70px;">
				<img alt="" src="/third_prj/resources/images/detail.png" style="width: 50px; height: 50px; margin-bottom: 20px; margin-right: 15px;"> <label style="font-size: 26px;">스터디 <strong>주제</strong>와 이 방의 <strong>규칙</strong>등을 자세히 설명해주세요
				</label>
