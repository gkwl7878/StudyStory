  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner-1">
      <div class="carousel-item active">
        <img src="http://211.63.89.144/resources/images/std1.jpg" class="d-block w-100" alt="..." style="height: 500px;">
        <div class="carousel-caption d-none d-md-block">
          <h2>편리하게 공부해요!</h2>
        </div>
      </div>
      <div class="carousel-item">
        <img src="http://211.63.89.144/resources/images/std2.jpg" class="d-block w-100" alt="..." style="height: 500px;">
        <div class="carousel-caption d-none d-md-block">
          <h2>함께 공부해요 !</h2>
        </div>
      </div>
      <div class="carousel-item">
        <img src="http://211.63.89.144/resources/images/std3.jpg" class="d-block w-100" alt="..." style="height: 500px;">
        <div class="carousel-caption d-none d-md-block">
          <h2>함께 즐겁게 여유롭게 !</h2>
        </div>
      </div>
...
<div class="intro">
	<div class="intro-num">
	<img src="http://211.63.89.144/resources/images/notebook.jpg" class="img-frm" style="margin-left: 50px">
	...
	<div class="intro-num">
	<img src="http://211.63.89.144/resources/images/book.jpg"  class="img-frm" style="float: right; margin-right: 50px">
	...
	<div class="intro-num">
	<img src="http://211.63.89.144/resources/images/fist.jpg"  class="img-frm"style="margin-left: 50px">
		<div class="text-1" style="float: right; text-align: right;">
