	...
	<div class="container form-group" id="wrap" >
		...
		<div class="row">
		    <div class="col-9 " style="margin-top: 10px; margin-left: 100px;">
				...
				<label style="width: 150px; margin-left: 30px;">2019</label>
				<label style="width: 100px; margin-left: 20px;" class="font17bold"><strong>답변여부</strong></label>
 			...
 			<div class=" row">
            <div class="col-9" style="margin-top: 10px; margin-left: 100px;">
    			<textarea class="form-control" rows="3" style="height: 300px;" name="contents" ></textarea>
  			</div>  
  			</div>  
 			<div class=" row">
            <div class="col-9" style="margin-top: 10px; margin-left: 100px; margin-top: 20px;">
    			<textarea class="form-control" rows="3" style="height: 300px;" name="contents" ></textarea>
  			</div>  
  			</div>  
	 ...
	 <a class="btn btn-secondary btn" href="#void" role="button" style="margin-left: 270px; margin-top: 30px;" >목록으로</a> 
	 <a class="btn btn-secondary btn" href="#void" role="button" style="margin-left:10px ; margin-top: 30px;" >재문의하기</a> 
	</div>
</form>
